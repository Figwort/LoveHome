...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:309927@/love_home?charset=utf8", 30)

	orm.RegisterModel(new(User), new(House), new(Facility), new(HouseImage), new(OrderHouse), new(Area))
